...
import UserReportPage from './Components/UserReport';
import NewFilmPage from './Components/NewFilmReport';
import GenrePersonalityPage from './Components/GenrePersonalityReport';
